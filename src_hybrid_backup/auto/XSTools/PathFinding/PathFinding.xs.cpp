...
#line 171 "src/auto/XSTools/PathFinding/PathFinding.c"
...
#line 184 "src/auto/XSTools/PathFinding/PathFinding.c"
	{
	    SV * RETVALSV;
...
#line 242 "src/auto/XSTools/PathFinding/PathFinding.c"
...
#line 563 "src/auto/XSTools/PathFinding/PathFinding.c"
    }
    XSRETURN_EMPTY;
}
...
#line 365 "src/auto/XSTools/PathFinding/PathFinding.xs"
		int status;
#line 581 "src/auto/XSTools/PathFinding/PathFinding.c"
	int	RETVAL;
	dXSTARG;
...
#line 651 "src/auto/XSTools/PathFinding/PathFinding.c"
	TARGi((IV)RETVAL, 1);
	ST(0) = TARG;
    }
    XSRETURN(1);
...
#line 433 "src/auto/XSTools/PathFinding/PathFinding.xs"
		int status;
#line 669 "src/auto/XSTools/PathFinding/PathFinding.c"
	int	RETVAL;
	dXSTARG;
...
#line 688 "src/auto/XSTools/PathFinding/PathFinding.c"
	TARGi((IV)RETVAL, 1);
	ST(0) = TARG;
    }
    XSRETURN(1);
...
#line 706 "src/auto/XSTools/PathFinding/PathFinding.c"
...
#line 717 "src/auto/XSTools/PathFinding/PathFinding.c"
    }
    XSRETURN_EMPTY;
}
...
#line 755 "src/auto/XSTools/PathFinding/PathFinding.c"
	TARGi((IV)RETVAL, 1);
	ST(0) = TARG;
    }
    XSRETURN(1);
...
#line 801 "src/auto/XSTools/PathFinding/PathFinding.c"
	TARGi((IV)RETVAL, 1);
	ST(0) = TARG;
    }
    XSRETURN(1);
...
#line 853 "src/auto/XSTools/PathFinding/PathFinding.c"
	TARGi((IV)RETVAL, 1);
	ST(0) = TARG;
    }
    XSRETURN(1);
...
#line 978 "src/auto/XSTools/PathFinding/PathFinding.c"
    }
    XSRETURN_EMPTY;
}
...
#line 1022 "src/auto/XSTools/PathFinding/PathFinding.c"
	TARGi((IV)RETVAL, 1);
	ST(0) = TARG;
    }
    XSRETURN(1);
...
#line 1067 "src/auto/XSTools/PathFinding/PathFinding.c"
    }
    XSRETURN_EMPTY;
}
...
#line 1098 "src/auto/XSTools/PathFinding/PathFinding.c"
	TARGi((IV)RETVAL, 1);
	ST(0) = TARG;
    }
    XSRETURN(1);
...
#line 1131 "src/auto/XSTools/PathFinding/PathFinding.c"
	TARGi((IV)RETVAL, 1);
	ST(0) = TARG;
    }
    XSRETURN(1);
...
#line 1212 "src/auto/XSTools/PathFinding/PathFinding.c"
	TARGi((IV)RETVAL, 1);
	ST(0) = TARG;
    }
    XSRETURN(1);
