...
#line 174 "src/auto/XSTools/utils/perl/HttpReader.c"
...
#line 223 "src/auto/XSTools/utils/perl/HttpReader.c"
...
#line 31 "src/auto/XSTools/utils/perl/HttpReader.xs"
	STRLEN dummy;
	char *buffer;
#line 256 "src/auto/XSTools/utils/perl/HttpReader.c"
...
#line 268 "src/auto/XSTools/utils/perl/HttpReader.c"
	TARGi((IV)RETVAL, 1);
	ST(0) = TARG;
    }
    XSRETURN(1);
...
#line 298 "src/auto/XSTools/utils/perl/HttpReader.c"
...
#line 68 "src/auto/XSTools/utils/perl/HttpReader.xs"
	StdHttpReader::init();
#line 367 "src/auto/XSTools/utils/perl/HttpReader.c"
    }
    XSRETURN_EMPTY;
}
...
#line 405 "src/auto/XSTools/utils/perl/HttpReader.c"
	{
	    SV * RETVALSV;
...
#line 97 "src/auto/XSTools/utils/perl/HttpReader.xs"
	...
	I32 i, len;
#line 453 "src/auto/XSTools/utils/perl/HttpReader.c"
...
#line 466 "src/auto/XSTools/utils/perl/HttpReader.c"
	{
	    SV * RETVALSV;
	    RETVALSV = sv_newmortal();
	    sv_setref_pv( RETVALSV, CLASS, (void*)RETVAL );
