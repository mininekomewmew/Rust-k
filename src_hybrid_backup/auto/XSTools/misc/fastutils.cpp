...
#line 176 "src/auto/XSTools/misc/fastutils.c"
...
#line 24 "src/auto/XSTools/misc/fastutils.xs"
	...
	AV *array;
	I32 len;
#line 195 "src/auto/XSTools/misc/fastutils.c"
#line 29 "src/auto/XSTools/misc/fastutils.xs"
	...
	if (ok) {
		...
		XSRETURN_UNDEF;
#line 241 "src/auto/XSTools/misc/fastutils.c"
...
#line 261 "src/auto/XSTools/misc/fastutils.c"
	int	RETVAL;
	dXSTARG;
...
#line 316 "src/auto/XSTools/misc/fastutils.c"
	TARGi((IV)RETVAL, 1);
	ST(0) = TARG;
    }
    XSRETURN(1);
...
#line 205 "src/auto/XSTools/misc/fastutils.xs"
	...
	bool done;
#line 425 "src/auto/XSTools/misc/fastutils.c"
...
#line 563 "src/auto/XSTools/misc/fastutils.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
#line 590 "src/auto/XSTools/misc/fastutils.c"
#line 362 "src/auto/XSTools/misc/fastutils.xs"
	...
	RETVAL = newSVpv ((const char *) data, len);
#line 621 "src/auto/XSTools/misc/fastutils.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
