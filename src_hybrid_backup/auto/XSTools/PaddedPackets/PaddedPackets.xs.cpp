...
#line 177 "src/auto/XSTools/PaddedPackets/PaddedPackets.c"
...
#line 197 "src/auto/XSTools/PaddedPackets/PaddedPackets.c"
	TARGu((UV)RETVAL, 1);
	ST(0) = TARG;
    }
    XSRETURN(1);
...
#line 38 "src/auto/XSTools/PaddedPackets/PaddedPackets.xs"
	...
	engine.addKey(7);
	RETVAL = engine.encode((byte *) packet, sitPacketID);
#line 225 "src/auto/XSTools/PaddedPackets/PaddedPackets.c"
	TARGu((UV)RETVAL, 1);
	ST(0) = TARG;
    }
    XSRETURN(1);
...
#line 255 "src/auto/XSTools/PaddedPackets/PaddedPackets.c"
	TARGu((UV)RETVAL, 1);
	ST(0) = TARG;
    }
    XSRETURN(1);
...
#line 274 "src/auto/XSTools/PaddedPackets/PaddedPackets.c"
    }
    XSRETURN_EMPTY;
}
...
#line 69 "src/auto/XSTools/PaddedPackets/PaddedPackets.xs"
	engine.setSync(sync);
#line 291 "src/auto/XSTools/PaddedPackets/PaddedPackets.c"
    }
    XSRETURN_EMPTY;
}
...
#line 308 "src/auto/XSTools/PaddedPackets/PaddedPackets.c"
    }
    XSRETURN_EMPTY;
}
...
#line 330 "src/auto/XSTools/PaddedPackets/PaddedPackets.c"
    }
    XSRETURN_EMPTY;
}
...
#line 91 "src/auto/XSTools/PaddedPackets/PaddedPackets.xs"
	sitPacketID = sit;
	skillPacketID = skill;
#line 350 "src/auto/XSTools/PaddedPackets/PaddedPackets.c"
    }
    XSRETURN_EMPTY;
}
...
#line 369 "src/auto/XSTools/PaddedPackets/PaddedPackets.c"
    }
    XSRETURN_EMPTY;
}
...
#line 388 "src/auto/XSTools/PaddedPackets/PaddedPackets.c"
	TARGu((UV)RETVAL, 1);
	ST(0) = TARG;
    }
    XSRETURN(1);
